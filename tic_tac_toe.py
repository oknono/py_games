...
def play_again():
    return raw_input("Do you want to play again?(Y)es/(N)o: ").lower().startswith('y')
...
# Do the setup - part of every new game
    ...
    time.sleep(2)
# Draw board & get computer and player feedback until one player wins or there is a tie
    while True:
